          ...
          {visibleTabs.map((tab) => (
            <button key={tab.key} onClick={() => setActiveTab(tab.key)}
              ...
              {tab.key === "status" && pendingCount > 0 && (
                <span className="ml-0.5 inline-flex items-center justify-center min-w-[16px] h-[16px] bg-yellow-400 text-yellow-900 text-[9px] font-bold rounded-full px-0.5">
                  {pendingCount}
                </span>
              )}
              {tab.key === "status" && staffApprovedCount > 0 && (
                <span className="ml-0.5 inline-flex items-center justify-center min-w-[16px] h-[16px] bg-orange-500 text-white text-[9px] font-bold rounded-full px-0.5">
                  {staffApprovedCount}
                </span>
              )}
            </button>
